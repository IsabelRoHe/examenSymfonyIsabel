 ...
 */
final class Version20210922160232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE nota (id INT AUTO_INCREMENT NOT NULL, estudiante_id INT NOT NULL, curso_id INT NOT NULL, nota DOUBLE PRECISION NOT NULL, INDEX IDX_C8D03E0D59590C39 (estudiante_id), INDEX IDX_C8D03E0D87CB4A1F (curso_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
